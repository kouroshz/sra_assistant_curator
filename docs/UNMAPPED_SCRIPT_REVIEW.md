...
- `scripts/41_batch_run_agentic_ai_on_trusted_queue.py`
  - recommendation: Referenced by non-legacy tracked files; do not move without manual inspection.
  - strong references: 2
  - strongly referenced by: scripts/41d_batch_run_trusted_queue_auto_chunked.py | scripts/41e_batch_run_trusted_queue_production.py
  - weak legacy/doc references: 0
...
- `scripts/41d_batch_run_trusted_queue_auto_chunked.py`
  - recommendation: Referenced by non-legacy tracked files; do not move without manual inspection.
  - strong references: 2
  - strongly referenced by: docs/TRUSTED_RNA_AI_PHASE_COMPLETION_REPORT.md | scripts/49_finalize_trusted_rna_ai_phase.py
  - weak legacy/doc references: 0
...
- `scripts/65_audit_chip_repeats_and_chunk_failures.py`
  - recommendation: Referenced by non-legacy tracked files; do not move without manual inspection.
  - strong references: 3
  - strongly referenced by: docs/POSTDOC_RERUN_RUNBOOK.md | scripts/00_audit_current_pipeline_for_reorg.py | scripts/69_postdoc_handoff_inventory.py
  - weak legacy/doc references: 0
